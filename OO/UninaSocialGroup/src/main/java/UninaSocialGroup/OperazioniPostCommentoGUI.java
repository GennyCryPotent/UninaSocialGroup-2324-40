...
public class OperazioniPostCommentoGUI extends JFrame {
	 ...
	 */
	public OperazioniPostCommentoGUI(String NU, String NG, GruppiGUI gruppiView) {
	...
	// -----------------------------------------
	// Schermata commento
	public OperazioniPostCommentoGUI(String NU, String NG, int Id_Contenuto, int checkSchermata) {
