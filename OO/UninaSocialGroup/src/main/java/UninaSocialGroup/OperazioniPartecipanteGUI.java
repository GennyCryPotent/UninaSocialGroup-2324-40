...
public class OperazioniPartecipanteGUI extends JFrame {
	...
	private GruppiController GC = new GruppiController(OperazioniPartecipanteGUI.this);
	String Ruolo;

	public OperazioniPartecipanteGUI(String NU, String NG, String Ruolo, int checkOperazione) {
		setResizable(false);
