		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.TRAILING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addGroup(groupLayout.createSequentialGroup().addContainerGap().addComponent(textAreaPost,
								GroupLayout.DEFAULT_SIZE, 590, Short.MAX_VALUE))
						...
						.addGroup(groupLayout.createSequentialGroup().addGroup(groupLayout
								...
								.addGroup(groupLayout.createSequentialGroup().addGroup(groupLayout
										...
										.addGroup(groupLayout.createSequentialGroup().addContainerGap().addComponent(
												textAddCommento, GroupLayout.PREFERRED_SIZE, 271,
												GroupLayout.PREFERRED_SIZE))
										.addGroup(groupLayout.createSequentialGroup().addGap(14).addComponent(
												lblAggiungiCommento, GroupLayout.DEFAULT_SIZE, 267, Short.MAX_VALUE))
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						...
						.addGroup(groupLayout.createSequentialGroup()
								.addComponent(textAddCommento, GroupLayout.PREFERRED_SIZE, 122,
										GroupLayout.PREFERRED_SIZE)
								.addGap(8).addComponent(btnNewButtonAddCommento).addGap(5)
								.addComponent(btnNewButtonRimCommento)))
				.addGap(433)));
